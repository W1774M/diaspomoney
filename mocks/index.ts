...
export const MOCK_USERS = [
  {
    ...
    createdAt: new Date(),
    updatedAt: new Date(),
    // Disponibilités du Dr. Jean Dupont
    availabilities: ['1', '2', '5'], // Planning standard, weekend, urgence
  },
  {
    _id: '2',
    name: 'Marie Martin',
    ...
    createdAt: new Date(),
    updatedAt: new Date(),
    // Marie Martin est un client, pas de disponibilités
    availabilities: [],
  },
  {
    _id: '3',
    ...
    createdAt: new Date(),
    updatedAt: new Date(),
    // Admin n'a pas de disponibilités spécifiques
    availabilities: [],
  },
  {
    _id: '4',
    ...
    createdAt: new Date(),
    updatedAt: new Date(),
    // Disponibilités de Dr. Sophie Laurent
    availabilities: ['3', '6'], // Planning mensuel et spécialisé
  },
  {
    _id: '5',
    ...
    createdAt: new Date(),
    updatedAt: new Date(),
    // Disponibilités de Dr. Pierre Moreau
    availabilities: ['5', '4'], // Planning urgence et congés (inactif)
  },
];
