    ...
    <header className="bg-black text-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center justify-center">
            ...
            >
              <Image src="/img/logos/Logo_DispoMoney_horiz_CMJN_web.png" width={200} height={100} alt='Diaspomoney' loading='lazy' />
            </h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="text-white hover:text-[hsl(23,100%,53%)]  hover:cursor-pointer">
              <User size={20} />
            </button>
          </div>
        </div>
