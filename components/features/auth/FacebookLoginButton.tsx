export function FacebookLoginButton() {
  ...
  return (
    <button
      type="button"
      disabled={true}
      className="w-full flex items-center justify-center px-4 py-2 mt-3 bg-gray-300 text-gray-500 font-semibold rounded-lg shadow transition-colors duration-200 cursor-not-allowed opacity-50"
    >
      ...
      Facebook (Temporairement indisponible)
    </button>
  );
}
