/**
 * Page de création d'une nouvelle carte bancaire
...
import type { CardFormData } from '@/hooks/payments/usePaymentMethodCreate';
...
export default function NewCardPage() {
  ...
  const { createCard, loading: saving } = usePaymentMethodCreate();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const method = await createCard(formData);
