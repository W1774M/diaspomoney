  ...
  const [receipts] = useState<PaymentReceipt[]>([
    {
      ...
      date: "2024-01-15",
      description: "Consultation de suivi médical",
      downloadUrl: "/receipts/INV-2024-001.pdf",
    },
    {
      id: "2",
      ...
      service: "Frais de scolarité",
      provider: "École Internationale",
      date: "2024-01-12",
      description: "Frais de scolarité - Janvier 2024",
      downloadUrl: "/receipts/INV-2024-002.pdf",
    },
    {
      id: "3",
      ...
      service: "Location appartement",
      provider: "Agence Immobilière ABC",
      date: "2024-01-10",
      description: "Caution et premier mois de loyer",
      downloadUrl: "/receipts/INV-2024-003.pdf",
    },
    {
      id: "4",
      ...
      date: "2024-01-08",
      description: "Remboursement - Médicaments non disponibles",
      downloadUrl: "/receipts/INV-2024-004.pdf",
    },
  ]);
